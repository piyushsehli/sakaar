...
<!--/down-->
	<div class="down">	
			  <a href="index.php"><img src="assets/images/admin.jpg"></a>
			  <a href="index.php"><span class=" name-caret"><?php echo $_SESSION['user_data']['name']; ?></span></a>
   ...
   <div class="menu">
			<ul id="menu" >
				<li><a href="index.php"><i class="fa fa-tachometer"></i> <span>Dashboard</span></a></li>
				 ...
				 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>Members</span> <span class="fa fa-angle-right" style="float: right"></span></a>
				   <ul id="menu-academico-sub">

					<li id="menu-academico-avaliacoes"><a href="addmember.php"> Add new member</a></li>

					<li id="menu-academico-boletim"><a href="addadmin.php">Add new admin</a></li>
					
					<li id="menu-academico-avaliacoes"><a href="calender.html">Update member</a></li>
